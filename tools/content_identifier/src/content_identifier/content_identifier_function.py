...
class ContentIdentifierFunctionConfig(FunctionBaseConfig, name="content_identifier"):
    ...
    api_key: str = Field(default_factory=lambda: os.getenv("DEEPSEEK_API_KEY", ""),
                        description="DeepSeek API key for accessing deepseek-v4-flash-vision-exp model")
    base_url: str = Field(default="https://api.deepseek.com",
                         description="API base URL for DeepSeek service")
    model_name: str = Field(default="deepseek-v4-flash-vision-exp",
